...
public class JDlgAblUsuarios extends javax.swing.JDialog {

    boolean alterar = false;
    public JDlgAblUsuarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    mascara.install(jFmtDataNascimento);
    ...
    private void initComponents() {
        ...
        jTxtCodigo.setBackground(new java.awt.Color(204, 255, 204));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jFmtDataNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jBtnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAlterarActionPerformed
        ...
        AblUsuarios usuario = (AblUsuarios) dao.list(id);
        if(usuario!=null){//encontrou no bd
    ...
    private void jBtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConfirmarActionPerformed
        ...
        usuario.setMpvAtivo(jChbAtivo.isSelected()? "S": "N");//if
        
        System.out.println("Texto da data: [" + jFmtDataNascimento.getText() + "]");

java.sql.Date data = Conversor.TextoToDate(jFmtDataNascimento.getText());

System.out.println("Data convertida: " + data);

usuario.setMpvDataNascimento(data);
    ...
    private void jBtnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnPesquisarActionPerformed
        JDlgAblUsuarioList telaListar = new JDlgAblUsuarioList(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgAblUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgAblUsuarios dialog = new JDlgAblUsuarios(new javax.swing.JFrame(), true);
