 ...
 * @author Alisson
 */
public class JFrmAblPrincipal extends javax.swing.JFrame {

    /**
     * Creates new form JFrmPrincipal
     */
    public JFrmAblPrincipal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Produtinhos");
        ...
        jMnuSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/alterar_1.png"))); // NOI18N
    ...
    private void jMnuUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnuUsuariosActionPerformed
        ...
        JDlgAblUsuarios jDlgMpvUsuarios = new JDlgAblUsuarios(null, true);
    ...
    private void jMnuClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnuClientesActionPerformed
        // TODO add your handling code here:
         JDlgAblClientes jDlgAblClientes = new JDlgAblClientes(null, true);
        jDlgAblClientes.setVisible(true);
    }//GEN-LAST:event_jMnuClientesActionPerformed

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // TODO add your handling code here:
         JDlgAblProdutos jDlgAblProdutos = new JDlgAblProdutos(null, true);
        jDlgAblProdutos.setVisible(true);
    }//GEN-LAST:event_jMenuItem1ActionPerformed

    private void jMnuVendasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMnuVendasActionPerformed
        // TODO add your handling code here:
        JDlgAblVenda jDlgVenda = new JDlgAblVenda(null, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmAblPrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmAblPrincipal().setVisible(true);
            }
        });
    }
